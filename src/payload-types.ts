...
export interface Site {
  ...
  name: string;
  /**
   * Used for yoursite.platform.com
   */
  subdomain: string;
  owner: number | User;
  /**
   * Shown only when visiting this site (subdomain).
   */
  description: string;
  redirects?: {
    redirects?:
...
export interface Page {
  ...
  title: string;
  /**
   * Optional: link page to a site for multi-tenant (subdomain)
   */
  ...
  /**
   * URL-friendly version of the title. Auto-generated on save if left empty.
   */
  slug: string;
  updatedAt: string;
  createdAt: string;
...
export interface CallToActionBlock {
  /**
   * Optional styling for this block (background, spacing, width).
   */
  style?: {
